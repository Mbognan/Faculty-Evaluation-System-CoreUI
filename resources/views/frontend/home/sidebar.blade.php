<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
        ...
        <li><a @if(Route::currentRouteName() === 'faculty.dashboard') class="active" @endif  href="{{ route('faculty.dashboard') }}"><i class="fas fa-tachometer"aria-hidden="true"></i>Dashboard</a></li>
