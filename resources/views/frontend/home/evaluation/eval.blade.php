            ...
            <div class="row active-with-click">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Blue">
                        <h2>
                            <span class="text-white">Christopher Walken</span>
                            <strong>
                ...
                {{--<div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Purple">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                He rose to international fame with his role as the Man with No Name in Sergio Leone's
                                Dollars trilogy of spaghetti Westerns during the 1960s ...
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Deep-Purple">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                He has been known for his versatile portrayals of antiheroes and vulnerable characters.[3]
                                He won the Academy Award for Kramer vs. Kramer in 1979 ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Indigo">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                He has been nominated for three Academy Awards for his work in the films Primal Fear,
                                American History X and Birdman. He also starred in other roles ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Blue">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                English actor and author. Renowned for his distinctive working class cockney accent, Caine
                                has appeared in over 115 films and is regarded as a British ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Light-Blue">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                Some of his most notable starring roles were in Martin Scorsese's Mean Streets and Taxi
                                Driver, Ridley Scott's The Duellists and Thelma & Louise, Quentin Tarantino ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Teal">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                He comes from a well-known acting family and began his televised acting in 1958 as a child
                                with his father, Lloyd Bridges, and brother, Beau, on television's Sea Hunt ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Green">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                is an American actor, producer, music video director, musician and activist. For his work as
                                an artist, Phoenix has received a Grammy Award, a Golden Globe Award and three Academy ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Lime">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                Best known for his distinctive supporting and character roles – typically lowlifes, bullies,
                                and misfits – Hoffman was a regular presence in films from the early 1990s until his death
                                at age 46.
                            </div>
                        </div>
                        <a class="mc-btn-action">
                    ...
                    <article class="material-card Yellow">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                ...
                                Color of Money,[3] a BAFTA Award, a Screen Actors Guild Award, a Cannes Film Festival Award,
                                an Emmy Award ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                    ...
                    <article class="material-card Amber">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                ...
                                greatest and most influential actor of all time.[2] A cultural icon, Brando is most famous
                                for his Academy ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Orange">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                He began his career as a stage actor during the 1980s, before being cast in supporting roles
                                in film and television. He gained critical acclaim in the early 1990s, culminating in his
                                first Academy Award ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                    ...
                    <article class="material-card Brown">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                ...
                                War-era counterculture, made him a top box-office draw of the 1960s and 1970s. McQueen
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <article class="material-card Grey">
                        ...
                        <div class="mc-content">
                            ...
                            <div class="mc-description">
                                Blonde, blue-eyed, tall and handsome Dutch actor Rutger Hauer has an international
                                reputation for playing everything from romantic leads to action heroes to sinister villains.
                                Hauer was born in Breukelen, a town in the province ...
                            </div>
                        </div>
                        <a class="mc-btn-action">
                            <i class="fa fa-bars"></i>
