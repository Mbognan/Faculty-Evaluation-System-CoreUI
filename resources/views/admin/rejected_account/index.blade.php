...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb mb-4">
      ...
      <li class="breadcrumb-item active"><span>Rejected Account</span></li>
  ...
  <div class="container">
    <div class="card mt-4 mb-6">
        ...
        <div class="card-body">
            ...
            <div id="no-data-message" class="alert alert-info mt-3" style="display: none;">No Rejected Account Available</div>
        </div>
    </div>
</div>
@endsection
